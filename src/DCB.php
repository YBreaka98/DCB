...
use Ybreaka98\DCB\Interfaces\EbtekarInterface;
use Ybreaka98\DCB\Responses\ConfirmLoginResponse;
use Ybreaka98\DCB\Responses\EbtekarResponse;
use Ybreaka98\DCB\Responses\ProtectedScriptResponse;
use Ybreaka98\DCB\Responses\ResponseFactory;
use Ybreaka98\DCB\Responses\SubscriptionDetailsResponse;
use Ybreaka98\DCB\Trait\Validation;

class DCB implements EbtekarInterface
{
    use Validation;

    private const string DEFAULT_DEVICE_TYPE = 'android';

    private const array PLATFORM = ['ebtekar'];
